...
class TestAlliedVision(unittest.TestCase):
    ...
    def test_set_woi_width_not_multiple(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'Width' with invalid value. 100 is not a multiple of 8, starting at 8",
            str(ctx.exception),
        )
    ...
    def test_set_woi_width_above_range(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'Width' with invalid value. 2472 is not within [8, 2464]", str(ctx.exception)
        )
        self.assertEqual(max_woi, self.cam.woi)
    ...
    def test_set_woi_height_below_range(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'Height' with invalid value. 0 is not within [8, 2064].", str(ctx.exception)
        )
        self.assertEqual(max_woi, self.cam.woi)
    ...
    def test_set_woi_height_above_range(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'Height' with invalid value. 2065 is not within [8, 2064].", str(ctx.exception)
        )
        self.assertEqual(max_woi, self.cam.woi)
    ...
    def test_set_woi_offsetx_not_multiple(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'OffsetX' with invalid value. 17 is not a multiple of 16, starting at 0",
            str(ctx.exception),
        )
        self.assertEqual(max_woi, self.cam.woi)
    ...
    def test_set_woi_offsetx_above_range(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'OffsetX' with invalid value. 2472 is not within [0, 2448].", str(ctx.exception)
        )
        self.assertEqual(max_woi, self.cam.woi)
    ...
    def test_set_woi_offsety_not_multiple(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'OffsetY' with invalid value. 1 is not a multiple of 8, starting at 0",
            str(ctx.exception),
        )
        self.assertEqual(max_woi, self.cam.woi)
    ...
    def test_set_woi_offsety_above_range(self):
        ...
        self.assertIn(
            "Called 'set()' of Feature 'OffsetY' with invalid value. 2064 is not within [0, 2056]", str(ctx.exception)
        )
        self.assertEqual(max_woi, self.cam.woi)
